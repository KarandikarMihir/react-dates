...
import DateRangePickerInputWithHandlers from
  '../../src/components/DateRangePickerInputWithHandlers';
...
describe('DateRangePicker', () => {
  describe('#render()', () => {
    ...
    it('renders <DateRangePickerInputWithHandlers />', () => {
      const wrapper = shallow(<DateRangePicker />);
      expect(wrapper.find(DateRangePickerInputWithHandlers)).to.have.length(1);
    });
