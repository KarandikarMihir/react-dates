...
import DateRangePickerInputWithHandlers
  from '../../src/components/DateRangePickerInputWithHandlers';
...
describe('DateRangePickerInputWithHandlersInputWithHandlers', () => {
  describe('#render', () => {
    it('renders a DateRangePickerInput', () => {
      const wrapper = shallow(<DateRangePickerInputWithHandlers />);
  ...
  describe('#clearDates', () => {
      ...
      describe('props.onFocusChange', () => {
        it('is called once', () => {
          ...
          const wrapper = shallow(
            <DateRangePickerInputWithHandlers
    ...
    describe('props.reopenPickerOnClearDates is falsy', () => {
      describe('props.onFocusChange', () => {
        it('is not called', () => {
          const onFocusChangeStub = sinon.stub();
          const wrapper =
            shallow(<DateRangePickerInputWithHandlers onFocusChange={onFocusChangeStub} />);
          wrapper.instance().clearDates();
    ...
    it('calls props.onDatesChange with arg { startDate: null, endDate: null }', () => {
      ...
      const wrapper =
        shallow(<DateRangePickerInputWithHandlers onDatesChange={onDatesChangeStub} />);
      wrapper.instance().clearDates();
  ...
  describe('#onStartDateChange', () => {
    describe('is a valid start date', () => {
      ...
      describe('is before props.endDate', () => {
        ...
        it('calls props.onDatesChange with correct arguments', () => {
          const onDatesChangeStub = sinon.stub();
          const wrapper = shallow(
            <DateRangePickerInputWithHandlers onDatesChange={onDatesChangeStub} endDate={endDate} />
          );
    ...
    describe('is not a valid date string', () => {
      ...
      it('calls props.onDatesChange with endDate === props.endDate', () => {
        const onDatesChangeStub = sinon.stub();
        const wrapper = shallow(
          <DateRangePickerInputWithHandlers onDatesChange={onDatesChangeStub} endDate={today} />
        );
        wrapper.instance().onStartDateChange(invalidDateString);
        const args = onDatesChangeStub.getCall(0).args[0];
  ...
  describe('#onStartDateFocus', () => {
    ...
    describe('props.disabled = true', () => {
      it('does not call props.onFocusChange', () => {
        const onFocusChangeStub = sinon.stub();
        const wrapper =
          shallow(<DateRangePickerInputWithHandlers disabled onFocusChange={onFocusChangeStub} />);
        wrapper.instance().onStartDateFocus();
